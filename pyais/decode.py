...
def decode_msg_4(bit_arr: bitarray.bitarray) -> Dict[str, Any]:
    ...
    return {
        ...
        'epfd': str(EpfdType(get_int_from_data(134, 138))),
        'raim': bit_arr[148],
...
def decode_msg_5(bit_arr: bitarray.bitarray) -> Dict[str, Any]:
    ...
    return {
        ...
        'shiptype': str(ShipType(get_int_from_data(232, 240))),
        ...
        'epfd': str(EpfdType(get_int_from_data(270, 274))),
...
def decode_msg_24(bit_arr: bitarray.bitarray) -> Dict[str, Any]:
    ...
    if not data['partno']:
        ...
        # Part B
        d = {
            'shiptype': str(ShipType(get_int_from_data(40, 48))),
